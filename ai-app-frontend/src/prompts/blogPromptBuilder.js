...
export const buildBlogPrompt = (module, variation, data) => {
        ...
        messages: [
          {
            role: 'system',
            content: `
  Ti si SEO blog pisac sa 10+ godina iskustva. Pišeš isključivo na srpskom jeziku, koristiš samo ispravne HTML oznake (<h1>, <h2>, <p>, <ul>, <li>), i NE koristiš markdown.
